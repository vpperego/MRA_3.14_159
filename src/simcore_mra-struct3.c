...
static void init_job_mra (void)
{
    ...
    job_mra.mra_task_dist[MRA_MAP] = xbt_new0 (int*, (config_mra.amount_of_tasks_mra[MRA_MAP] *config_mra.mra_number_of_workers) * (sizeof (int)));
    job_mra.mra_task_dist[MRA_MAP][mra_wid] = xbt_new0 (int*, (config_mra.mra_number_of_workers) * (sizeof (config_mra.amount_of_tasks_mra[MRA_MAP] * (sizeof (int)))));
    for (i = 0; i < config_mra.mra_number_of_workers; i++)
    {
      job_mra.mra_task_dist[MRA_MAP][i] = xbt_new0 (int*, (config_mra.mra_number_of_workers) * (sizeof (config_mra.amount_of_tasks_mra[MRA_MAP] * (sizeof (int)))));
    }
    for (i = 0; i < config_mra.amount_of_tasks_mra[MRA_MAP]; i++)
    {
	  job_mra.task_list[MRA_MAP][i] = xbt_new0 (msg_task_t, MAX_SPECULATIVE_COPIES);
    job_mra.mra_task_dist[MRA_MAP][mra_wid][i] = xbt_new0 (int, config_mra.amount_of_tasks_mra[MRA_MAP] * (sizeof (int)));
    }
    ...
    job_mra.mra_task_dist[MRA_REDUCE] = xbt_new (int**, (config_mra.amount_of_tasks_mra[MRA_REDUCE] * config_mra.mra_number_of_workers) * (sizeof (int)));
    job_mra.mra_task_dist[MRA_REDUCE][mra_wid] = xbt_new0 (int*, (config_mra.mra_number_of_workers) * (sizeof (config_mra.amount_of_tasks_mra[MRA_REDUCE] * (sizeof (int)))));
    for (i = 0; i < config_mra.mra_number_of_workers; i++)
    {
      job_mra.mra_task_dist[MRA_REDUCE][i] = xbt_new (int*, (config_mra.mra_number_of_workers) * (sizeof (config_mra.amount_of_tasks_mra[MRA_REDUCE] * (sizeof (int)))));
    }
    for (i = 0; i < config_mra.amount_of_tasks_mra[MRA_REDUCE]; i++)
    {
	  ...
	  job_mra.mra_task_dist[MRA_REDUCE][mra_wid][i] = xbt_new0 (int, config_mra.amount_of_tasks_mra[MRA_REDUCE] * (sizeof (int)));
	  }
